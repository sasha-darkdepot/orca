  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center bg-background overflow-auto">
      <div className="w-full max-w-md px-6 py-8 flex flex-col items-center">
        {/* Worktree name */}
        <div className="text-[15px] uppercase tracking-widest text-muted-foreground/60 mb-5">
          {worktreeName}
        </div>
          ...
          <div className="w-full max-w-sm">
            {sessionGroups.map((group) => (
              <div key={group.label} className="mb-3">
                <div className="text-[14px] uppercase tracking-wider text-muted-foreground/50 mb-2 px-1">
                  {group.label}
                </div>
                <div className="flex flex-col gap-0.5">
                  {group.sessions.map((session) => (
                    ...
                    >
                      ...
                      <span className="text-[15px] text-muted-foreground/40 shrink-0">
        ...
        {sessions.length === 0 && (
          <div className="text-[14px] text-muted-foreground/40 mt-2">No recent sessions</div>
        )}
      </div>
    </div>
  )
